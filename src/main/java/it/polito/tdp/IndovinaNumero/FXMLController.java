...
public class FXMLController {
	...
	private Model model ; 
	// fai attenzione a quale package importi 
    ...
    void doTentativo(ActionEvent event) {
    	...
    	//= this.model.tentativo(tentativo) ;
    	try {
...
// 		problema nel caso in cui ci siano più controller quindi lo faccio nell'Entry Point
//       this.model = new Model() ;
    }
    // collego il riferimento al model del controller con quello dell'Entry point che lo 
    // inizializza
